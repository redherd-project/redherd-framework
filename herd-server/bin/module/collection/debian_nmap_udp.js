...
// moduleCode: debian_nmap_udp
class DebianNmapUDP extends LinuxModule
{
    // ************************************************************
    //  NmapUDP module
    // ************************************************************
    ...
    {
        super(asset, "debian_nmap_udp", session, wsServer, token);
    ...
    run(whatIf = false)
    {
        if (this.validate())
        {
            let task = "sudo nmap -Pn -sU -p" + this.ports + " " + this.target;
