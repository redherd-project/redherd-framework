...
// moduleCode: windows_nmap_udp
class WindowsNmapUDP extends WindowsModule
{
    // ************************************************************
    //  NmapUDP module
    // ************************************************************
    ...
    {
        super(asset, "windows_nmap_udp", session, wsServer, token);
    ...
    run(whatIf = false)
    {
        if (this.validate())
        {
            let task = "nmap -Pn -sU -p" + this.ports + " " + this.target;
